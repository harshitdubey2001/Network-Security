...
MONGO_DB_URL=os.getenv("mongodb+srv://harshitdubey7896_db_user:Admin123@cluster0.azxb6ub.mongodb.net/?retryWrites=true&w=majority")
    ...
    def split_data_as_train_test(self,datframe:pd.DataFrame):
       try:
          train_set,test_set=train_test_split(
             datframe,test_size=self.data_ingestion_config.train_test_split_ratio
          )
