...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.valid_data_dir:str=os.path.join(self.data_validation_dir,training_pipeline.
        ...
        self.drift_report_file_path:str=os.path.join(
            ...
            training_pipeline.DATA_VALIDATION_DRIFT_REPORT_FILE_NAME_DIR
            )
...
class DataTranformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_object_file_path:str=os.path.join(self.data_transformation_dir,training_pipeline.DATA_TRANSFORMATION_TRANSFORMED_OBJECT_DIR,training_pipeline.PREPROCESSOR_OBJECT_FILE_NAME)
...
class ModelTrainerConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        self.overfitting_underfitting_threshold = training_pipeline.MODEL_TRAINER_OVER_FITING_UNDER_FITING_THRESHOLD
