...
class DataTransformation:
    def __init__(self,data_validation_artifact:DatavalidationArtifacts,data_transformation_config:DataTranformationConfig):
        try:
            self.data_validation_artifacts:DatavalidationArtifacts=data_validation_artifact
